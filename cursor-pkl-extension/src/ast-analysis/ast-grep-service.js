...
class ASTGrepService {
  ...
  async analyzeSource(source, language = 'JavaScript') {
    return {
      functions: this.extractFunctions(source, language),
      classes: this.extractClasses(source, language),
      modules: this.extractModules(source, language)
...
`;
    ...
    try {
      console.log('Testing AST-Grep Service...');
      
      // Analyze the code
      const analysis = service.analyzeSource(jsCode, 'JavaScript');
      
      console.log('Analysis Result:');
      console.log(`Functions found: ${analysis.functions.length}`);
      console.log(`Classes found: ${analysis.classes.length}`);
      console.log(`Imports found: ${analysis.modules.imports.length}`);
      console.log(`Exports found: ${analysis.modules.exports.length}`);
      ...
      analysis.functions.forEach((func, index) => {
        ...
        console.log(`  Is Async: ${func.isAsync}`);
      });
      ...
      analysis.classes.forEach((cls, index) => {
        ...
        console.log(`  Start Line: ${cls.startLine}`);
      });
      
      // Get summary
      const summary = service.getAnalysisSummary();
