  ...
  modal.innerHTML = `
    <div class="modal-content" style="max-width: 800px; max-height: 90vh; overflow-y: auto;">
      ...
      <div class="modal-body" style="padding: var(--space-lg);">
        ...
        <div style="margin-bottom: var(--space-xl); padding: var(--space-lg); background: var(--color-bg-alt); border-radius: 0(--radius-md); border-left: 4px solid var(--color-primary);">
          <h3 style="display: flex; align-items: center; gap: var(--space-sm); margin-top: 0; margin-bottom: var(--space-md); color: var(--color-primary);">
            <span style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; background: var(--color-primary); color: white; border-radius: 0; font-weight: 600;">1</span>
          ...
          <div style="margin-bottom: var(--space-md);">
            ...
            <div style="background: var(--color-bg); border: 1px solid var(--color-border); border-radius: 0(--radius-sm); padding: var(--space-md); font-family: var(--font-mono); font-size: var(--text-sm); color: var(--color-text); margin-bottom: var(--space-sm);">
            ...
            <p style="font-size: var(--text-sm); color: var(--color-text-muted); margin-top: var(--space-sm);">
              The service will start on <code style="background: var(--color-bg); padding: 2px 6px; border-radius: 0; font-family: var(--font-mono);">http://localhost:43917</code>
            </p>
          </div>
        </div>

        <!-- Step 2: Privacy Settings -->
        <div style="margin-bottom: var(--space-xl); padding: var(--space-lg); background: var(--color-bg-alt); border-radius: 0(--radius-md); border-left: 4px solid var(--color-warning);">
          <h3 style="display: flex; align-items: center; gap: var(--space-sm); margin-top: 0; margin-bottom: var(--space-md); color: var(--color-warning);">
            <span style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; background: var(--color-warning); color: white; border-radius: 0; font-weight: 600;">2</span>
          ...
          <div style="margin-bottom: var(--space-md);">
            ...
            <div style="background: var(--color-bg); border: 1px solid var(--color-border); border-radius: 0(--radius-sm); padding: var(--space-md); margin-bottom: var(--space-sm);">
            ...
            <div style="background: rgba(42, 42, 42, 0.1); border: 1px solid var(--color-info); border-radius: 0(--radius-sm); padding: var(--space-md); margin-top: var(--space-md);">
        ...
        <div style="margin-bottom: var(--space-xl); padding: var(--space-lg); background: var(--color-bg-alt); border-radius: 0(--radius-md); border-left: 4px solid var(--color-success);">
          <h3 style="display: flex; align-items: center; gap: var(--space-sm); margin-top: 0; margin-bottom: var(--space-md); color: var(--color-success);">
            <span style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; background: var(--color-success); color: white; border-radius: 0; font-weight: 600;">3</span>
        ...
        <!-- Next Steps -->
        <div style="margin-bottom: var(--space-lg); padding: var(--space-lg); background: var(--color-bg-alt); border-radius: 0(--radius-md); color: white;">
        ...
        <!-- Help Section -->
        <div style="padding: var(--space-md); background: var(--color-bg); border: 1px solid var(--color-border); border-radius: 0(--radius-md);">
          <h4 style="margin-top: 0; margin-bottom: var(--space-sm); color: var(--color-text); font-size: var(--text-base);">
            <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" style="display: inline-block; vertical-align: middle; margin-right: var(--space-xs); color: var(--color-info);">
